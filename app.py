...
def render_mapa_3d_biocore(coordenadas, osm_context=None, height=560):
    ...
    fig.update_layout(
        ...
        title=dict(
            text="BioCore 3D · Copernicus DEM GLO-30",
            x=0.02,
            xanchor="left",
        ),
        scene=dict(
...
def crear_portada_biocore():
    ...
    .bc-hero{
        ...
        background:
            radial-gradient(circle at 82% 24%, rgba(14,165,233,.17), transparent 30%),
            radial-gradient(circle at 72% 80%, rgba(34,197,94,.12), transparent 32%),
            linear-gradient(135deg, rgba(15,23,42,.98), rgba(10,18,32,.96));
    ...
    .bc-visual{
        ...
        background:
          ...
          radial-gradient(ellipse at 50% 70%, rgba(34,197,94,.20), transparent 48%),
          radial-gradient(ellipse at 58% 44%, rgba(14,165,233,.27), transparent 46%),
          #07111f;
        background-size:28px 28px,28px 28px,auto,auto,auto;
        box-shadow:inset 0 0 70px rgba(2,8,23,.5);
    }
    .bc-terrain-a,.bc-terrain-b,.bc-terrain-c{
        position:absolute;
        left:-8%;
        width:116%;
    ...
    .bc-terrain-a{height:120px;bottom:18px;}
    .bc-terrain-b{height:170px;bottom:-3px;left:-2%;opacity:.72;}
    .bc-terrain-c{height:225px;bottom:-55px;left:5%;opacity:.45;}
    .bc-aoi{
        position:absolute;
    ...
    .bc-point{
        ...
        background:#4ade80;
        box-shadow:0 0 0 6px rgba(74,222,128,.13),0 0 18px rgba(74,222,128,.75);
        left:65%;top:36%;
    }
    .bc-visual-label{
        position:absolute;
    ...
    .bc-card-icon{font-size:1.25rem;margin-bottom:10px;}
    .bc-card-title{color:#f1f5f9;font-weight:750;margin-bottom:6px;}
    .bc-card-copy{color:#94a3b8;font-size:.83rem;line-height:1.55;}
    .bc-flow{
        display:grid;
    ...
    .bc-principle{
        ...
        border-radius:18px;
        padding:19px 20px;
        background:linear-gradient(100deg,rgba(14,165,233,.08),rgba(34,197,94,.05));
        color:#cbd5e1;
        line-height:1.62;
        font-size:.88rem;
    }
    .bc-principle b{color:#f8fafc;}
    .bc-tech{
        display:flex;
        flex-wrap:wrap;
    ...
    @media(max-width:850px){
        ...
        .bc-visual{min-height:255px;}
        .bc-card-grid{grid-template-columns:1fr;}
        .bc-flow{grid-template-columns:repeat(2,1fr);}
        .bc-audience{grid-template-columns:repeat(2,1fr);}
    }
    @media(max-width:520px){
        .bc-public-shell{padding-top:0;}
        .bc-hero{border-radius:18px;padding:22px 17px;}
        .bc-visual{min-height:225px;}
        .bc-flow{grid-template-columns:1fr 1fr;}
        .bc-audience{grid-template-columns:1fr 1fr;}
        .bc-card{min-height:auto;}
    }
    </style>

    <div class="bc-public-shell">
      <section class="bc-hero">
        <div class="bc-hero-grid">
          <div>
            <div class="bc-kicker">● BioCore Intelligence</div>
            <h1>Inteligencia ambiental y geoespacial para decisiones trazables</h1>
            <p class="bc-hero-lead">
              Monitorea cambios ambientales y territoriales mediante observación satelital,
              análisis temporal, radar y visualización 3D. BioCore transforma datos
              geoespaciales en evidencia explicable, reportes verificables y alertas
              para apoyar el seguimiento de proyectos.
            </p>
            <div class="bc-chip-row">
              <span class="bc-chip">Vigilancia ambiental</span>
              <span class="bc-chip">Series temporales</span>
              <span class="bc-chip">Terreno 3D</span>
              <span class="bc-chip">Radar e InSAR</span>
              <span class="bc-chip">Alertas</span>
              <span class="bc-chip">Reportes trazables</span>
            </div>
          </div>

          <div class="bc-visual" aria-label="Representación conceptual del visor geoespacial BioCore">
            <div class="bc-visual-label">Territorio · evidencia · seguimiento</div>
            <div class="bc-terrain-a"></div>
            <div class="bc-terrain-b"></div>
            <div class="bc-terrain-c"></div>
            <div class="bc-aoi"></div>
            <div class="bc-point"></div>
            <div class="bc-visual-bottom">
              <span>AOI / relieve / capas</span>
              <span>2D + 3D</span>
            </div>
          </div>
        </div>
      ...
      <section class="bc-section">
        <div class="bc-section-title">Del territorio a una decisión comprensible</div>
        <div class="bc-section-sub">
          La plataforma organiza la complejidad técnica para que cada resultado pueda
          entenderse, revisarse y documentarse.
        </div>
        <div class="bc-card-grid">
          <div class="bc-card">
            <div class="bc-card-icon">🛰️</div>
            <div class="bc-card-title">Observa</div>
            <div class="bc-card-copy">
              Integra satélites, clima, radar, relieve y contexto territorial en un mismo análisis.
            </div>
          </div>
          <div class="bc-card">
            <div class="bc-card-icon">🧠</div>
            <div class="bc-card-title">Comprende</div>
            <div class="bc-card-copy">
              Separa dato, comparación, interpretación, confusores y limitaciones antes de concluir.
            </div>
          </div>
          <div class="bc-card">
            <div class="bc-card-icon">📄</div>
            <div class="bc-card-title">Documenta</div>
            <div class="bc-card-copy">
              Genera informes verificables, historial de análisis y mensajería vinculados por trazabilidad.
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="bc-section">
        <div class="bc-section-title">Un flujo de trabajo trazable</div>
        <div class="bc-section-sub">
          Cada etapa conserva su origen y sus límites para que el usuario pueda reconstruir cómo se obtuvo el resultado.
        </div>
        <div class="bc-flow">
          <div class="bc-step"><b>1 · Territorio</b>Área de estudio</div>
          <div class="bc-step"><b>2 · Datos</b>Sensores y contexto</div>
          <div class="bc-step"><b>3 · Calidad</b>QA y disponibilidad</div>
          <div class="bc-step"><b>4 · Cambio</b>Comparación temporal</div>
          <div class="bc-step"><b>5 · Interpretación</b>Evidencia y límites</div>
          <div class="bc-step"><b>6 · Reporte</b>Salida verificable</div>
        </div>
      </section>

      <section class="bc-section">
        <div class="bc-section-title">Pensado para proyectos que necesitan evidencia</div>
        <div class="bc-audience">
          <div class="bc-audience-item">⛏️ Minería</div>
          <div class="bc-audience-item">🌿 Gestión ambiental</div>
          <div class="bc-audience-item">🏗️ Infraestructura</div>
          <div class="bc-audience-item">🗺️ Gestión territorial</div>
        </div>
      </section>

      <div class="bc-principle">
        <b>Explicabilidad antes que automatización ciega.</b><br>
        BioCore no convierte automáticamente una señal satelital en una conclusión.
        Distingue observación, interpretación, limitaciones y criterios regulatorios,
        para que el usuario pueda comprender qué respalda cada resultado y qué debe
      ...
      <div class="bc-cta">
        <div class="bc-cta-title">¿Quieres evaluar un área o proyecto?</div>
        <div class="bc-cta-copy">
          Si ya eres cliente, utiliza <b>Acceso de clientes</b> desde el panel lateral.
          Para información, demostraciones o consultas:
          <a href="mailto:consultorabiocore@gmail.com">consultorabiocore@gmail.com</a>
        </div>
      </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    if not plan:
        return {
            ...
            "summary": (
                ...
                "instrumento con umbrales trazables. BioCore no determina "
...
def guardar_reporte_canonico(report: Dict[str, Any]):
    ...
    try:
        ...
        msg = str(exc)
        if "schema_version" in msg or "analysis_id" in msg or "payload_json" in msg:
            raise RuntimeError(
                "La migración del reporte canónico aún no está aplicada en Supabase. "
                "Ejecuta migracion_reporte_canonico_v2.sql en SQL Editor."
            ) from exc
        raise
...
def ejecutar_analisis_canonico(
    ...
    if save:
        guardar_reporte_canonico(canonical)
            ...
            try:
                ...
                if view_mode == "🛰️ Mapa técnico 2D":
                    ...
                    load_osm = st.checkbox(
                        "Añadir edificios y caminos OSM cuando existan",
                        value=True,
                        key="vig_osm3d",
                        help="Contexto visual opcional; no se usa como topografía de precisión.",
                    )
                    osm_context = fetch_osm_3d_context(coords) if load_osm else None
                    if osm_context and osm_context.get("warning"):
                        st.caption(osm_context["warning"])
            ...
            if st.button("🚀 Ejecutar análisis", key="vig_run", use_container_width=True):
                with st.spinner("Consultando sensores y construyendo evidencia trazable..."):
                    try:
                        ...
                        st.success(f"Análisis guardado · ID {report['analysis_id'][:12]}")
                    except Exception as exc:
